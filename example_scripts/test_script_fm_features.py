...
from split.PiezoSortRegion import PiezoSortRegion
...
startjunc1 = Junction((1000-size/2,1000-size/2),60)
...
startjunc7 = Junction((4500-size/2,1500-size/2),0)
...
startjunc8 = Junction((4500-size/2,5000-size/2),0)
...
startjunc9 = Junction((8500-size/2,1500-size/2),10-settings_drop_extr['entrance_angle_oil'])
drop_extr = DropletExtractor(chip,startjunc=startjunc9,settings=settings_drop_extr)

startjunc10 = Junction((8500-size/2,5000-size/2),90)
...
startjunc11 = Junction((9000-size/2,5000-size/2),90)
